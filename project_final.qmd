...
# posteriors
# pplot_linear <-
plot(model_linear, "areas", prob = 0.95, prob_outer = 1) + 
...
To further compare the predictive performances of the model, calibration plots are visualized in @Calibration-plots. From these plots we can see that both models are calibrated on approximately the interval of [0.25, 0.5] of predicted probabilities. For the top 10% there are more predictions than observations, and for the bottom 20% there are more observations than predictions.
