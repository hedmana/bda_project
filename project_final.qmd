...
Due to the nature of the nonlinear model, and the large number of parameters, the sensitivity analysis is summarized with the help of a posterior predicitve check (@fig-prior-sensitivity-plots-nonlinear).
