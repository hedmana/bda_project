...
In conclusion, this analysis indicates that when it comes the "cath" data set, the linear and the non-linear model performs equally. As seen in the prior sensitivity analysis, the choice of priors does not have a significant impact on the 
