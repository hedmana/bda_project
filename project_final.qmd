...
```
When performing the prior sensitivity analysis of the nonlinear model, they presented with zero to a few divergent transitions. Furhter indicating good fits to the data.
