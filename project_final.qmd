...
The posteriors of the linear model with the new sets of priors are plotted in @fig-prior-sensitivity-plots.
...
Due to the nature of the nonlinear model, and the large number of parameters, the sensitivity analysis is summarized with the help of a posterior predicitve check.
...
Further, the divergent transitions were studied:
...
data.frame(diversions = c(div_default, div_flat, div_normal_loc, div_normal_sd))
